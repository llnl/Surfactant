...
- **version_arg** (string): Argument to pass into the executable, looking for a regex match for the software version. Set to `--version` by default. (i.e. `executable_name --version`)
